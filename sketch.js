...
function preload() {
  img = loadImage("./assets/Monalisa-Louvre-Museum-Paris-France-3.png");
  img2 = loadImage("https://t3.ftcdn.net/jpg/01/63/32/14/360_F_163321474_z4nFzE9qu0UDq2mOcHjkKUKfDStGgolV.jpg");
}

function setup() {
  createCanvas(600, 375, WEBGL);
